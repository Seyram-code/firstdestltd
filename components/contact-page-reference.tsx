        ...
        <div className="mt-5 grid gap-5 lg:grid-cols-[1fr_1.25fr]">
          ...
          <section className="space-y-5">
            <div className="rounded-md border border-slate-200 bg-white p-5 shadow-sm md:p-6">
              ...
              <div className="mt-4 h-[260px] overflow-hidden rounded border border-slate-200 bg-slate-100"><iframe title="Map showing First Dest office location" src="https://www.google.com/maps?q=Adenta+Taxi+Rank,+Near+ECG+Substation,+Accra,+Ghana&output=embed" className="h-full w-full border-0" loading="lazy" /></div>
            ...
            <div className="grid gap-5 sm:grid-cols-[1.2fr_0.8fr]">
              <div className="relative min-h-[190px] overflow-hidden rounded-md"><Image src="/company-building.jpg" alt="First Dest office area" fill sizes="(max-width: 640px) 100vw, 40vw" className="object-cover" /></div>
