    ...
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <section className="bg-white py-12 md:py-16">
        <div className="mx-auto grid max-w-7xl gap-6 px-4 md:grid-cols-[0.85fr_0.85fr_1.3fr] md:px-6">
          ...
          <div className="relative min-h-[320px] overflow-hidden rounded-md shadow-soft"><img src="/about-reception.png" alt="First Dest office reception" className="h-full w-full object-cover" /><div className="absolute inset-x-4 bottom-4 rounded bg-brand-900/90 px-5 py-4 text-sm italic leading-6 text-white">&quot;Creating opportunities today for a better tomorrow.&quot;</div></div>
